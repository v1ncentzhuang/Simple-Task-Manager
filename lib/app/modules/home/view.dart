...
import 'package:todolist/app/widgets/add_card.dart';
import 'package:todolist/app/widgets/add_dialog.dart';
import 'package:todolist/app/widgets/task_card.dart';
          ...
          () => FloatingActionButton(
              ...
              onPressed: () {
                if(controller.tasks.isNotEmpty) {
                  ...
                  EasyLoading.showInfo('Please create a folder');
                }
              },
              child: Icon(controller.deleting.value ? Icons.delete_forever : Icons.add_to_photos)
          ),
        );
      },
      onAccept: (Task task) {
